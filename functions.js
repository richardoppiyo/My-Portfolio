...
const projectList = [{
  ...
  'featured image' : "/images/ueab.png",
  technologies : {
    "tech1" :"Ruby on rails",
    "tech2" :"CSS",
    "tech3" :"JavaScript",
  ...
  'link to source' : "https://github.com/microverse-students/palindrome-richardoppiyo"
},
{
...
projectList.forEach((item) => {
  ...
  cardElement1.innerHTML = "<p> Hello </p>"

  // cardElement1.innerHTML = "<img src="" alt=""/>";

  const cardElement2 = document.createElement('div2');
  cardElement2.classList.add('container-title');
  cardElement2.innerHTML = "<p> Hello </p>"
